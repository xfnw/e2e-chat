...
<head>
    <meta charset="utf-8" />
    <title>Home - End-to-end Encrypted Chat</title>
...
<body>
    ...
    if(is_readable(CONFIG_FILE_NAME)) {
        ...
        <p>
            End-to-end Encrypted Chat can't read the configuration file.<br />
    ...
    <p>
        End-to-end Encrypted Chat can't edit the database file.<br />
    ...
    <p>
        End-to-end Encrypted Chat can't edit the logs file.<br />
